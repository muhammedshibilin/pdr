...
const SOCIAL_LINKS = [
  {
    name: 'Instagram',
    url: 'https://instagram.com/tm_pdr?igsh=MTlvaXg4czB4NXd3eA==',
    icon: (
  ...
  {
    name: 'Facebook',
    url: 'https://facebook.com/profile.php?id=100087388090213&mibextid=LQQJ4d',
    icon: (
      <svg className="w-8 h-8 hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'YouTube',
    url: 'https://youtube.com/@tmpdr?si=X6i7OJWEE8emP_bV',
    icon: (
      <svg className="w-8 h-8 hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
    ...
    <>
      ...
      <div className="min-h-screen relative flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4 py-20">
          ...
          <p className="text-xl md:text-2xl mb-16 animate-fade-in-delay">
            Stay tuned!
          </p>
          ...
          {/* Description */}
          <p className="max-w-xl text-lg text-gray-600 text-center mb-16">
            We support your business growth through strategic digital marketing and advertising solutions.
